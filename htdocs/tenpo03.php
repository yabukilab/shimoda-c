...
<html>
	...
	<?php
			...
			try
			{
				...
				$sql='SELECT * FROM keihindata WHERE ID LIKE "510%"';
...
<center>
		<?php
				...
				print '<kei3>アミューズメントエース津田沼</kei3><br/>';
				print '<kei4>千葉県船橋市前原西2-15-1　ファミービル1F～3F</kei4><br/><br/>';
