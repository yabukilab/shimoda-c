...
<html>
	...
	<?php
			...
			try
			{
				...
				$sql='SELECT * FROM keihindata WHERE ID LIKE "625%"';
...
<center>
		<?php
				...
				print '<kei3>モーリーファンタジー</kei3><br/>';
				print '<kei4>千葉県習志野市津田沼1-23-1　イオンモール津田沼　イオン津田沼店3F</kei4><br/><br/>';
