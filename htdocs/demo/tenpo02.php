...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Morisia AMUSE PARK</title>
	...
	<?php
			...
			try
			{
				...
				$sql='SELECT * FROM keihindata WHERE ID LIKE "467%"';
...
<center>
		<?php
				...
				print '<kei3>Morisia AMUSE PARK</kei3><br/>';
				print '<kei4>千葉県習志野市谷津1-16-1 モリシア津田沼店2F</kei4><br/><br/>';
